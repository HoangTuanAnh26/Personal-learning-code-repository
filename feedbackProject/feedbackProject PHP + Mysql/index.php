...
<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?> " method="post">
    <div class="mb-3">
        <input type="text" class="form-control <?php echo $name_error ? 'is-invalid' : ''; ?>" name="name"
            placeholder="What is your name?">
        <p class="text-danger"><?php echo $name_error ?></p>
    </div>
    <div class="mb-3">
        <input type="email" class="form-control <?php echo $email_error ? 'is-invalid' : ''; ?>" name="email"
            placeholder="Enter your email">
        <p class="text-danger"><?php echo $email_error ?></p>
    </div>
    <div class="mb-3">
        <textarea class="form-control <?php echo $body_error ? 'is-invalid' : ''; ?>" name="body"
            placeholder="Enter your feedback" rows="2"></textarea>
